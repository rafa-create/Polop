...
La trajectoire de prévisualisation remplace les grandes cordes droites au-dessus du Landscape par des positions recalées sur le terrain **à chaque échantillon** entre 16 h 59 et 17 h 58, assorties de petites arches réversibles de 12 cm qui suggèrent des rebonds. Une pause à position fixe entre 17 h 16 et 17 h 30 représente l'immobilisation dans la fissure, sans prétendre simuler la collision avec les pierres ou l'appui du chevreuil. Le segment 17 h 35–17 h 40 prépare le fragment « anneau ↓ / eau ↑ » ; **l'écoulement et le chevreuil ne sont pas encore générés**. Le plan B4_ANNEAU conserve six secondes, mais sa caméra est rapprochée et sa focale se resserre davantage afin de mieux identifier le proxy au milieu de sa descente. Aucune lueur « magique » n'est ajoutée.
