...
## Passe anneau — trajectoire de blockout (20 septembre 2026)

Le générateur actif conserve **un seul anneau, une seule piste Sequencer, et une seule position pour chaque instant objectif**. La lecture B échantillonne cette même trajectoire à rebours : aucun anneau supplémentaire, aucun raccord spatial fabriqué pour le plan de détail. Les mouvements des personnages, les 43 plans, les durées, les dialogues et les ancrages objectifs 17 h/18 h ne changent pas.

La trajectoire de prévisualisation remplace les grandes cordes droites au-dessus du Landscape par des positions recalées sur le terrain **à chaque échantillon** entre 17 h 01 et 18 h 00, assorties de petites arches réversibles de 12 cm qui suggèrent des rebonds. Une pause à position fixe entre 17 h 18 et 17 h 32 représente l'immobilisation dans la fissure, sans prétendre simuler la collision avec les pierres ou l'appui du chevreuil. Le segment 17 h 37–17 h 42 prépare le fragment « anneau ↓ / eau ↑ » ; **l'écoulement et le chevreuil ne sont pas encore générés**. Le plan B4_ANNEAU conserve six secondes, mais sa caméra est rapprochée et sa focale se resserre davantage afin de mieux identifier le proxy au milieu de sa descente. Aucune lueur « magique » n'est ajoutée.
